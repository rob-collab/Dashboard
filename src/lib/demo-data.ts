...
export const demoRisks: Risk[] = [
  {
    ...
    categoryL2: "Products",
    ownerId: "user-cath",
    riskOwner: DEMO_USERS.find(u => u.id === "user-cath"),
    ...
    mitigations: [
      { id: "mit-001-1", riskId: "risk-001", action: "Implement automated customer outcome testing for all product changes", owner: "Chris", deadline: "2026-03-31", status: "IN_PROGRESS", actionId: null, createdAt: "2026-01-10T10:00:00Z" },
    ],
  },
  {
    id: "risk-002",
    ...
    ownerId: "user-ash",
    riskOwner: DEMO_USERS.find(u => u.id === "user-ash"),
    inherentLikelihood: 3,
    inherentImpact: 4,
    residualLikelihood: 2,
    residualImpact: 3,
  ...
  },
  {
    ...
    ownerId: "user-chris",
    riskOwner: DEMO_USERS.find(u => u.id === "user-chris"),
    ...
    mitigations: [
      { id: "mit-003-1", riskId: "risk-003", action: "Implement zero-trust network architecture", owner: "Chris", deadline: "2026-06-30", status: "IN_PROGRESS", actionId: null, createdAt: "2025-12-01T10:00:00Z" },
    ],
  },
  {
    id: "risk-004",
    ...
    ownerId: "user-david",
    riskOwner: DEMO_USERS.find(u => u.id === "user-david"),
    inherentLikelihood: 3,
    inherentImpact: 5,
    residualLikelihood: 2,
    residualImpact: 4,
    ...
    updatedBy: "user-rob",
    controls: [
      { id: "ctrl-004-1", riskId: "risk-004", description: "Monthly cash flow forecasting with 13-week rolling window and stress scenarios", controlOwner: "David", sortOrder: 0, createdAt: "2025-06-15T10:00:00Z" },
      { id: "ctrl-004-2", riskId: "risk-004", description: "Board-approved liquidity buffer of 120% of 90-day outflows", controlOwner: "David", sortOrder: 1, createdAt: "2025-06-15T10:00:00Z" },
      { id: "ctrl-004-3", riskId: "risk-004", description: "Funding diversification strategy with maximum single-source limit of 40%", controlOwner: "David", sortOrder: 2, createdAt: "2025-06-15T10:00:00Z" },
    ],
    mitigations: [],
  },
  {
    ...
    updatedBy: "user-rob",
    controls: [
      { id: "ctrl-005-1", riskId: "risk-005", description: "Cross-training programme for all critical roles", controlOwner: "Chris", sortOrder: 0, createdAt: "2025-06-15T10:00:00Z" },
      { id: "ctrl-005-2", riskId: "risk-005", description: "Comprehensive process documentation and knowledge base", controlOwner: "Chris", sortOrder: 1, createdAt: "2025-06-15T10:00:00Z" },
      { id: "ctrl-005-3", riskId: "risk-005", description: "Succession planning for all senior and specialist roles", controlOwner: "Chris", sortOrder: 2, createdAt: "2025-06-15T10:00:00Z" },
    ],
    mitigations: [
      { id: "mit-005-1", riskId: "risk-005", action: "Complete succession plans for remaining 3 specialist roles", owner: "Chris", deadline: "2026-04-30", status: "OPEN", actionId: null, createdAt: "2026-01-20T14:00:00Z" },
    ],
  },
  {
    id: "risk-006",
