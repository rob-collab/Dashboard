...
async function main() {
  ...
  const HORIZON_ITEMS: {
    ...
    {
      id: "hz-001", reference: "HZ-001", title: "BNPL (Buy Now Pay Later) FCA Final Rules",
      category: "FCA_REGULATORY", source: "FCA", urgency: "HIGH", status: "ACTION_REQUIRED",
      summary: "The FCA is expected to publish final rules bringing BNPL products within the Consumer Credit Act regulatory perimeter in Q1 2026. Firms offering credit-adjacent products or using BNPL integrations must assess their regulatory status.",
      whyItMatters: "Updraft's lending products and partnerships may be impacted if any integrated payment or deferred credit features fall within scope. An early gap analysis against the expected rules is required to ensure readiness ahead of any implementation deadline.",
      deadline: new Date("2026-06-30"), sourceUrl: "https://www.fca.org.uk/firms/buy-now-pay-later",
      actions: "1. Conduct gap analysis of all credit-adjacent product features\n2. Engage compliance counsel on regulatory perimeter\n3. Assess impact on T&Cs, affordability processes, and disclosures",
      notes: "Flagged as P1 issue by CCRO at January ExCo. Watch for PS/26/x publication.", monthAdded: "February 2026", inFocus: false, addedById: "user-rob",
    },
    {
      id: "hz-002", reference: "HZ-002", title: "PSR Mandatory APP Fraud Reimbursement — Implementation Review",
      category: "PAYMENTS_REGULATORY", source: "PSR", urgency: "HIGH", status: "IN_PROGRESS",
      summary: "The PSR's mandatory APP fraud reimbursement framework came into force October 2024. The PSR is conducting a 12-month post-implementation review. Firms must evidence robust fraud detection, prevention, and dispute handling processes.",
      whyItMatters: "Updraft customers may be victims of APP fraud targeting their accounts. The firm must demonstrate adequate controls to avoid reimbursement liability and pass PSR scrutiny during the review period.",
      deadline: new Date("2026-04-01"), sourceUrl: "https://www.psr.org.uk/our-work/app-scams/",
      actions: "1. Review fraud detection controls and dispute handling SLAs\n2. Prepare evidence pack for any PSR data request\n3. Update customer communications on APP fraud prevention",
      notes: "Cath leading. Fraud controls review underway with IT.", monthAdded: "February 2026", inFocus: false, addedById: "user-cath",
    },
    {
      id: "hz-003", reference: "HZ-003", title: "Consumer Credit Act Reform — HM Treasury Consultation Response",
      category: "LEGISLATIVE", source: "HM Treasury", urgency: "HIGH", status: "ACTION_REQUIRED",
      summary: "HM Treasury is consulting on a wholesale reform of the Consumer Credit Act 1974. The reform will modernise the consumer credit regulatory framework, potentially changing disclosure requirements, creditworthiness assessments, and s.75 liability rules.",
      whyItMatters: "As a consumer lender, Updraft's entire product and compliance framework is built on CCA obligations. Any legislative change to affordability, disclosure, or s.75 liability will require material updates to processes, systems, and customer-facing documents.",
      deadline: new Date("2026-05-31"), sourceUrl: "https://www.gov.uk/government/consultations/reforming-the-consumer-credit-act-1974",
      actions: "1. Review consultation paper in full — assign CCRO and Legal\n2. Draft and submit response by consultation deadline\n3. Begin scenario planning for potential rule changes",
      notes: "Consultation closes Q2 2026. Expected final legislation 2027.", monthAdded: "February 2026", inFocus: false, addedById: "user-rob",
    },
    {
      id: "hz-004", reference: "HZ-004", title: "FCA CP26/7 — Consumer Duty: Fair Value and Sludge Practices",
      category: "FCA_REGULATORY", source: "FCA", urgency: "HIGH", status: "ACTION_REQUIRED",
      summary: "FCA Consultation Paper 26/7 proposes targeted interventions on fair value assessment and the elimination of 'sludge' practices — design features that make it unreasonably difficult for consumers to exercise their rights or switch provider. Firms must review UX, cancellation journeys, and pricing transparency.",
      whyItMatters: "Consumer Duty Year 2 is intensifying FCA scrutiny of fair value outcomes. Updraft must review all customer journeys for sludge practices — particularly account closure, repayment management, and communications — and demonstrate pricing is genuinely fair value.",
      deadline: new Date("2026-07-31"), sourceUrl: "https://www.fca.org.uk/publications/consultation-papers/cp26-7",
      actions: "1. Map all customer journeys against sludge practice checklist in CP26/7\n2. Conduct fair value assessment for all core products\n3. Prepare consultation response — deadline Q2 2026\n4. Update Board Duties Champion on implications",
      notes: "In Focus — CCRO has identified this as the most material near-term Consumer Duty risk. Board update scheduled for March 2026 ExCo.", monthAdded: "February 2026", inFocus: true, addedById: "user-rob",
    },
    {
      id: "hz-005", reference: "HZ-005", title: "FCA Operational Resilience — Post-March 2025 Supervisory Focus",
      category: "FCA_REGULATORY", source: "FCA", urgency: "HIGH", status: "IN_PROGRESS",
      summary: "The March 2025 deadline for PS21/3 important business services and impact tolerances has passed. The FCA is now in active supervisory mode — reviewing firms' self-assessments and testing whether impact tolerances are genuinely embedded, not just documented.",
      whyItMatters: "Updraft must be able to demonstrate to the FCA that its important business services remain within impact tolerances under realistic stress scenarios. Gaps in evidence or untested tolerances create significant supervisory risk.",
      deadline: new Date("2026-03-31"), sourceUrl: "https://www.fca.org.uk/firms/operational-resilience",
      actions: "1. Complete self-assessment against PS21/3 requirements\n2. Test impact tolerances for each important business service\n3. Evidence testing results and remediation actions in Board pack",
      notes: "Op Res page updated. Chris leading the testing programme.", monthAdded: "February 2026", inFocus: false, addedById: "user-cath",
    },
    {
      id: "hz-006", reference: "HZ-006", title: "FCA SMCR Reform — Discussion Paper DP23/5 Final Position",
      category: "FCA_REGULATORY", source: "FCA", urgency: "MEDIUM", status: "MONITORING",
      summary: "Following DP23/5 on SMCR reform, HM Treasury and the FCA are expected to publish a joint consultation in H1 2026 with proposed changes to the certification regime, conduct rules, and fit and proper requirements.",
      whyItMatters: "Any changes to certification scope or conduct rule obligations will require updates to Updraft's SMCR framework, fit and proper assessments, and training programme.",
      deadline: null, sourceUrl: "https://www.fca.org.uk/publications/discussion-papers/dp23-5",
      actions: "1. Monitor for joint HMT/FCA consultation publication\n2. Pre-read DP23/5 responses to anticipate direction of travel",
      notes: null, monthAdded: "February 2026", inFocus: false, addedById: "user-rob",
    },
    {
      id: "hz-007", reference: "HZ-007", title: "FCA Financial Promotions — Approval Gateway Ongoing Compliance",
      category: "FCA_REGULATORY", source: "FCA", urgency: "MEDIUM", status: "MONITORING",
      summary: "The FCA's financial promotions approval gateway for unauthorised persons is now embedded. The FCA is actively supervising approver firms and publishing outcome data on the quality of promotions approved.",
      whyItMatters: "Updraft's financial promotions must comply with COBS 4 and Consumer Duty fair communications standards. Any approval failures could disrupt marketing activity and damage the brand.",
      deadline: null, sourceUrl: "https://www.fca.org.uk/consumers/financial-promotions",
      actions: "1. Refresh financial promotions approval process and log\n2. Review all live customer-facing marketing against current FCA guidance",
      notes: null, monthAdded: "February 2026", inFocus: false, addedById: "user-cath",
    },
    {
      id: "hz-008", reference: "HZ-008", title: "AI Regulation — UK DSIT Pro-Innovation Framework Update",
      category: "DATA_TECHNOLOGY", source: "DSIT / ICO", urgency: "MEDIUM", status: "MONITORING",
      summary: "DSIT is expected to publish updated AI governance guidance in 2026. The ICO has also published detailed guidance on AI and data protection. EU AI Act high-risk system provisions apply to credit decisioning models.",
      whyItMatters: "Updraft's credit scoring and affordability assessment models may be classified as high-risk under EU AI Act principles. Explainability, bias testing, and human oversight are expected for automated credit decisions affecting consumers.",
      deadline: new Date("2026-12-31"), sourceUrl: "https://www.gov.uk/government/publications/ai-regulation-a-pro-innovation-approach",
      actions: "1. Audit credit decisioning models against ICO AI guidance\n2. Document explainability and bias testing processes\n3. Review Article 22 GDPR compliance for automated decisions",
      notes: null, monthAdded: "February 2026", inFocus: false, addedById: "user-rob",
    },
    {
    ...
    {
      id: "hz-013", reference: "HZ-013", title: "Data (Use and Access) Bill — UK Data Reform",
      category: "DATA_TECHNOLOGY", source: "DSIT / ICO", urgency: "MEDIUM", status: "MONITORING",
      summary: "The Data (Use and Access) Bill is progressing through Parliament. Key provisions include smart data schemes, changes to data subject rights, and a new framework for recognised legitimate interests under UK GDPR.",
      whyItMatters: "Changes to UK GDPR legitimate interests, consent requirements, and data subject rights will affect Updraft's data processing, marketing consent, and customer data management practices.",
      deadline: new Date("2026-12-31"), sourceUrl: "https://bills.parliament.uk/bills/3825",
      actions: "1. Track Bill progress — assign DPO to monitor key amendments\n2. Assess impact of legitimate interests provisions on marketing and analytics",
      notes: null, monthAdded: "February 2026", inFocus: false, addedById: "user-cath",
    },
    {
    ...
    {
      id: "hz-016", reference: "HZ-016", title: "Employment Rights Bill — Worker Rights Expansion",
      category: "EMPLOYMENT", source: "DBET", urgency: "MEDIUM", status: "MONITORING",
      summary: "The Employment Rights Bill (introduced October 2024) is progressing through Parliament. Key measures include day-one unfair dismissal rights, strengthened collective redundancy rules, and new rights for zero-hours contract workers.",
      whyItMatters: "Updraft's employment practices, contractor arrangements, and HR policies will need updating on Royal Assent. Day-one unfair dismissal rights in particular affect probationary period management.",
      deadline: new Date("2026-10-01"), sourceUrl: "https://bills.parliament.uk/bills/3737",
      actions: "1. HR to review employment contracts and probationary period policies\n2. Assess contractor and zero-hours arrangements against new rights framework",
      notes: null, monthAdded: "February 2026", inFocus: false, addedById: "user-rob",
    },
    {
